...
JNIEXPORT jboolean JNICALL Java_com_ChenYusong_ImageSearch_CLIP_loadCLIP(JNIEnv* env, jobject thiz, jobject assetManager, jstring jvocab)
{
...
JNIEXPORT jboolean JNICALL Java_com_ChenYusong_ImageSearch_CLIP_clear(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL Java_com_ChenYusong_ImageSearch_CLIP_set(JNIEnv* env, jobject thiz, jint num)
{
    image_features_stack.clear();
...
JNIEXPORT jboolean JNICALL Java_com_ChenYusong_ImageSearch_CLIP_encodeImage(JNIEnv* env, jobject thiz, jobject bitmap, jint cnt)
{
...
JNIEXPORT jboolean JNICALL Java_com_ChenYusong_ImageSearch_CLIP_encodeText(JNIEnv* env, jobject thiz, jstring in)
{
    double start_time = ncnn::get_current_time();
...
JNIEXPORT jint JNICALL Java_com_ChenYusong_ImageSearch_CLIP_go(JNIEnv* env, jobject thiz)
{
    double start_time = ncnn::get_current_time();
